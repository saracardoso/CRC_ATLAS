...
invisible(gc())
# 1.8. Save object
SeuratDisk::SaveH5Seurat(Tcells_4, paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_4.h5Seurat', sep='/'), overwrite=TRUE)
...
write.csv(Tcells_4_markers, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C4_res09.csv', sep='/'))
# 3.2. Get top 20 markers for each sub-cluster
...
write.csv(Tcells_4_markers_top20, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C4_res09_top20.csv', sep='/'))
...
invisible(gc())
# 1.8. Save object
SeuratDisk::SaveH5Seurat(Tcells_5, paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_5.h5Seurat', sep='/'), overwrite=TRUE)
...
write.csv(Tcells_5_markers, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C5_res07.csv', sep='/'))
# 3.2. Get top 20 markers for each sub-cluster
...
write.csv(Tcells_5_markers_top20, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C5_res07_top20.csv', sep='/'))
...
invisible(gc())
# 1.8. Save object
SeuratDisk::SaveH5Seurat(Tcells_6, paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_6.h5Seurat', sep='/'), overwrite=TRUE)
...
write.csv(Tcells_6_markers, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C6_res03.csv', sep='/'))
# 3.2. Get top 20 markers for each sub-cluster
...
write.csv(Tcells_6_markers_top20, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C6_res03_top20.csv', sep='/'))
...
invisible(gc())
# 3.8. Save object
SeuratDisk::SaveH5Seurat(Tcells_07, paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_07.h5Seurat', sep='/'), overwrite=TRUE)
...
write.csv(Tcells_7_markers, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C07_res01.csv', sep='/'))
# 3.2. Get top 20 markers for each sub-cluster
...
write.csv(Tcells_7_markers_top20, paste(project_dir, '2_annotation/Results/new_Tcells/markers_C07_res01_top20.csv', sep='/'))
...
Tcells_0 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_0.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.1. C1
Tcells_1 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_1.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.2. C2
Tcells_2 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_2.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.3. C3
Tcells_3 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_3.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.4. C4
Tcells_4 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_4.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.5. C5
Tcells_5 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_5.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.6. C6
Tcells_6 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_6.h5Seurat', sep='/'), overwrite=TRUE)
...
# 2.7. C07
Tcells_07 = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_07.h5Seurat', sep='/'), overwrite=TRUE)
...
SeuratDisk::SaveH5Seurat(Tcells, paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_temporaryAnnots.h5Seurat', sep='/'), overwrite=T)
...
# -----
Tcells = SeuratDisk::LoadH5Seurat(paste(project_dir, '2_annotation/Results/new_Tcells/Tcells_temporaryAnnots.h5Seurat', sep='/'))
...
# 9. Visualize cells annotated in the different levels
...
# 10. Separate cells in CD4 Tcells, run umap and visualize (annotations, feature plots, violin plots)
# 10.1. Subset
...
# 11. Separate cells in CD8 Tcells, run umap and visualize (annotations, feature plots, violin plots)
# 11.1. Subset
...
# 12. Unconventional Tcells + ILCs + DNs, run umap and visualize (annotations, feature plots, violin plots)
# 12.1. Subset
...
# 13. Violin plot with only NK, NKT and CD8 subsets:
...
# 14. Get Markers between the final annotations:
# 14.1. Annotation Level 6
