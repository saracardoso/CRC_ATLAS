...
In general, to perform cell annotation, we evaluated the RNA counts expression of certain genes, known to be markers of certain cell-types, on clusters of cells obtained using the integrated data. We detail all the pipeline for each of the big groups in the following chapters. Also, original code files for the annotation of all cells are [here](https://github.com/saracardoso/CRC_ATLAS/tree/master/2_annotation).
